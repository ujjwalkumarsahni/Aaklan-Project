...
const Curriculum = () => {
  ...
  return (
    <section 
      ref={sectionRef}
      className="relative w-full py-16 lg:py-24 bg-linear-to-br from-gray-50 to-white overflow-hidden"
    >
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div className={`flex flex-col lg:flex-row items-start gap-12 mb-16 transition-all duration-700 ${
          ...
          <div className="lg:w-2/5">
            <div className="inline-flex items-center px-4 py-2 bg-linear-to-r from-[#0b234a]/10 to-[#E22213]/10 rounded-full border border-[#0b234a]/20 mb-6">
            ...
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#0b234a] mb-6 leading-tight">
              Unique <span className="bg-linear-to-r from-[#E22213] via-orange-500 to-[#0b234a] bg-clip-text text-transparent">Skill Curriculum</span>
            </h2>
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="text-center p-4 bg-white rounded-2xl shadow-lg border border-gray-100">
                <div className="text-2xl font-bold bg-linear-to-r from-orange-500 to-[#E22213] bg-clip-text text-transparent">100+</div>
          ...
          <div className="hidden sm:block lg:w-3/5">
            <div className="bg-white rounded-3xl border-2 border-gray-100 p-6 shadow-xl hover:shadow-2xl transition-all duration-500 group">
              <div className="flex items-start gap-6">
                <div className={`w-20 h-20 rounded-2xl bg-linear-to-br ${skills[activeCard].color} p-2 shadow-lg shrink-0 group-hover:scale-110 transition-transform duration-300`}>
                ...
                <div className="flex-1">
                  ...
                  <button className="px-6 py-3 bg-linear-to-r from-[#0b234a] to-[#E22213] text-white font-medium rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 hover:from-[#E22213] hover:to-orange-500">
        ...
        <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 transition-all duration-700 delay-300 ${
          ...
          {skills.map((skill, index) => (
            ...
            >
              ...
              <div className={`absolute inset-0 bg-linear-to-br ${skill.color} rounded-2xl opacity-0 group-hover:opacity-5 transition-opacity duration-300`}></div>

              {/* Icon and Title Row */}
              <div className="flex items-center gap-4 mb-4">
                <div className={`w-16 h-16 rounded-xl bg-linear-to-br ${skill.color} p-1.5 shadow-lg transition-all duration-300 group-hover:scale-110 ${
                ...
                <h3 className={`text-lg font-bold transition-colors duration-300 ${
                  activeCard === index 
                    ? `bg-linear-to-r ${skill.color} bg-clip-text text-transparent`
                    : 'text-gray-900'
                }`}>
                  {skill.title}
                </h3>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                  <div className="w-2 h-2 bg-linear-to-r from-[#E22213] to-orange-500 rounded-full animate-pulse"></div>
              ...
              {/* Hover Effect Line */}
              <div className={`absolute bottom-0 left-0 w-0 h-1 bg-linear-to-r ${skill.color} rounded-full transition-all duration-500 group-hover:w-full`}></div>
            </div>
          ))}
        </div>
        ...
        <div className={`text-center mt-16 transition-all duration-700 delay-500 ${
          ...
          <div className="bg-linear-to-r from-[#0b234a]/5 via-[#E22213]/5 to-orange-500/5 rounded-3xl p-8 border border-[#0b234a]/10 shadow-lg">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <button className="px-6 py-3 bg-linear-to-r from-[#0b234a] to-[#E22213] text-white font-medium rounded-xl shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300">
                Schedule a Demo
              </button>

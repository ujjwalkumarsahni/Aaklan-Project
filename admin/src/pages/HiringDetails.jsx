...
import StatusCount from "../components/StatusCount.jsx";
...
//   // Resume decisions with Swal confirmation
//   const handleDecision = async (id, decision) => {
//     const result = await Swal.fire({
//       title: `Are you sure you want to ${decision} this candidate?`,
//       text: decision === 'shortlist' 
//         ? "This will move the candidate to the next round." 
//         : "This will reject the candidate's application.",
//       icon: decision === 'shortlist' ? 'question' : 'warning',
//       showCancelButton: true,
//       confirmButtonColor: decision === 'shortlist' ? '#10B981' : '#EF4444',
...
//           { decision }
//         );
//         showSwalAlert('Success!', res.data.message, 'success');
//         fetchApplicants();
//       } catch (error) {
//         showSwalAlert('Error!', error.response?.data?.message || "Server error", 'error');
//       }
//     }
//   };
...
//   const handleSendTopic = async (id) => {
//     const result = await Swal.fire({
//       title: 'Send Topic for Video Interview?',
//       text: 'This will send an email to the candidate with the interview topic.',
//       icon: 'info',
//       showCancelButton: true,
...
//     setCurrentResume(resumeLink);
//     setShowResume(true);
//     showSwalAlert('Resume Preview', 'Viewing candidate resume', 'info');
//   };
...
//     setShowVideo(true);
//     setInterviewDetails({ interviewDate: "", interviewTime: "", zoomLink: "" });
//     showSwalAlert('Video Review', 'Reviewing candidate video submission', 'info');
//   };

//   const handleVideoDecision = async (id, decision) => {
//     const title = decision === "shortlist" 
//       ? "Shortlist & Schedule Interview?" 
//       : "Reject Candidate?";
    
//     const text = decision === "shortlist"
//       ? "This will shortlist the candidate and schedule the next interview."
//       : "This will reject the candidate's application.";
...
//       confirmButtonColor: decision === "shortlist" ? '#10B981' : '#EF4444',
//       cancelButtonColor: '#6B7280',
//       confirmButtonText: decision === "shortlist" ? 'Yes, Shortlist' : 'Yes, Reject',
//       cancelButtonText: 'Cancel',
//       reverseButtons: true
//     });
...
//     const stageName = stage === "technicalInterview" ? "Technical Interview" : "HR Interview";
//     showSwalAlert(`Schedule ${stageName}`, `Scheduling interview for ${applicant.name}`, 'info');
//   };

//   const handleNextStageSubmit = async () => {
//     const result = await Swal.fire({
//       title: 'Schedule Interview?',
//       text: currentStageApplicant?.technicalInterview?.interviewDate || currentStageApplicant?.hrInterview?.interviewDate
//         ? 'This will reschedule the interview.'
//         : 'This will schedule the interview.',
//       icon: 'question',
//       showCancelButton: true,
//       confirmButtonColor: '#3B82F6',
//       cancelButtonColor: '#6B7280',
...
//   const handleMarkInterviewClear = async () => {
//     const result = await Swal.fire({
//       title: 'Mark Interview as Cleared?',
//       text: `This will mark ${currentStageApplicant?.name}'s interview as cleared and move to next stage.`,
//       icon: 'success',
//       showCancelButton: true,
...
//       text: `Create offer letter for ${applicant.name}?`,
//       icon: 'question',
//       showCancelButton: true,
//       confirmButtonColor: '#10B981',
//       cancelButtonColor: '#6B7280',
...
//         text: 'Please fill in all required fields (Name, Role, and Net Salary).',
//         icon: 'error',
//         confirmButtonColor: '#EF4444'
//       });
//       return;
...
//       html: `
//         <div class="text-left">
//           <p>Are you sure you want to send the offer letter to <strong>${offerFormData.name}</strong>?</p>
//           <div class="mt-3 p-2 bg-gray-100 rounded">
//             <p><strong>Role:</strong> ${offerFormData.role}</p>
//             <p><strong>Net Salary:</strong> ₹${offerFormData.netSalary}</p>
//             <p><strong>Joining Date:</strong> ${offerFormData.dateOfJoining}</p>
//           </div>
//         </div>
//       `,
//       icon: 'question',
...
//         text: 'This will reject the candidate from the recruitment process.',
//         icon: 'warning',
//         showCancelButton: true,
//         confirmButtonColor: '#EF4444',
//         cancelButtonColor: '#6B7280',
...
//     // For other stages (status changes)
//     const stageNames = {
//       "technicalInterview_cleared": "Technical Interview Cleared",
//       "hrInterview_cleared": "HR Interview Cleared"
//     };

//     const result = await Swal.fire({
//       title: 'Update Status?',
//       text: `Change status to "${stageNames[stage] || stage}"?`,
//       icon: 'question',
//       showCancelButton: true,
//       confirmButtonColor: '#3B82F6',
//       cancelButtonColor: '#6B7280',
...
//   // Add Swal confirmation for modal close
//   const handleModalClose = (setModalFunction, modalName) => {
//     Swal.fire({
//       title: `Close ${modalName}?`,
//       text: 'All unsaved changes will be lost.',
//       icon: 'warning',
//       showCancelButton: true,
//       confirmButtonColor: '#EF4444',
...
//             <div className="bg-white w-full max-w-4xl rounded-2xl shadow-2xl p-6 relative">
//               <button
//                 onClick={() => handleModalClose(setShowResume, "Resume Preview")}
//                 className="absolute top-4 right-4 z-10 p-2 rounded-lg bg-white/80 hover:bg-white text-gray-600 hover:text-gray-900 transition-all"
//               >
//                 <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
//                   <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
...
//             <div className="bg-white w-full max-w-2xl rounded-2xl shadow-2xl p-6 relative max-h-[90vh] overflow-y-auto">
//               <button
//                 onClick={() => handleModalClose(setShowVideo, "Video Review")}
//                 className="absolute top-4 right-4 z-10 p-2 rounded-lg bg-white/80 hover:bg-white text-gray-600 hover:text-gray-900 transition-all"
//               >
//                 <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
//                   <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
...
//             <div className="bg-white w-full max-w-md rounded-2xl shadow-2xl p-6 relative">
//               <button
//                 onClick={() => handleModalClose(setShowStageModal, "Interview Schedule")}
//                 className="absolute top-4 right-4 p-2 rounded-lg hover:bg-gray-100 text-gray-600 transition-colors"
//               >
//                 <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
//                   <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
